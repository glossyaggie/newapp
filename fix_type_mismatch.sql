-- Fix type mismatch in get_class_roster function
-- Run this in Supabase SQL Editor

-- Update the function with correct return types
CREATE OR REPLACE FUNCTION get_class_roster(class_id UUID)
RETURNS TABLE (
  booking_id UUID,
  user_name TEXT,
  user_email VARCHAR(255),  -- Changed from TEXT to VARCHAR(255)
  checked_in BOOLEAN,
...
-- Test the function
SELECT * FROM get_class_roster('4e3d5dba-9678-4b8e-9745-d49953dded4e');
